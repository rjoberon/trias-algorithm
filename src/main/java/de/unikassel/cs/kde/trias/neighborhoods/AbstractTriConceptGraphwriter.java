 ...
 * 
 * @author:  rja
 * @version: $Id: AbstractTriConceptGraphwriter.java,v 1.1 2010-07-16 09:14:47 rja Exp $
 * $Author: rja $
 * 
 */
public abstract class AbstractTriConceptGraphwriter<T extends Comparable<T>> implements GraphWriter<TriConcept<T>> {
